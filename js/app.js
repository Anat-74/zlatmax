    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".icon-menu")) {
                    ...
                    if (document.documentElement.classList.contains("sub-menu-open-tablet")) document.documentElement.classList.remove("sub-menu-open-tablet");
                    if (document.documentElement.classList.contains("_sub-menu-open")) document.documentElement.classList.add("_sub-menu-open");
                }
            }));
        }
        ...
        function docActions(e) {
            ...
            if (targetElement.closest("[data-parent]")) {
                ...
                const subMemu = document.querySelector(`[data-submenu='${subMenuId}']`);
                if (subMemu) {
                    const activeLink = document.querySelector("._sub-menu-active");
                    const activeOpen = document.querySelector("._sub-menu-open");
                    if (activeLink && activeLink != targetElement) {
                        activeLink.classList.remove("_sub-menu-active");
                        activeOpen.classList.remove("_sub-menu-open");
                        document.documentElement.classList.remove("sub-menu-open-tablet");
                    }
                    targetElement.classList.toggle("_sub-menu-active");
                    subMemu.classList.toggle("_sub-menu-open");
                    document.documentElement.classList.toggle("sub-menu-open-tablet");
                } else console.log("Ничего не нашлось");
                e.preventDefault();
            }
            if (targetElement.closest(".menu-header-top__link_catalog")) document.documentElement.classList.add("catalog-open");
            e.preventDefault();
            if (targetElement.closest(".menu-catalog__back")) document.documentElement.classList.remove("catalog-open");
            e.preventDefault();
        ...
        if (menuBlocks.length) menuBlocks.forEach((item => {
            const menuBlockItem = item.querySelectorAll(".sub-menu-catalog__category").length;
            item.classList.add(`sub-menu-catalog__block_${menuBlockItem}`);
        }));
